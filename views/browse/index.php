...
$this->registerJsVar('cfilesEditFolderUrl', $contentContainer->createUrl('/cfiles/edit/folder', ['id' => '--itemId--']));
$this->registerJsVar('cfilesEditFileUrl', $contentContainer->createUrl('/cfiles/edit/file', ['id' => '--itemId--']));
$this->registerJsVar('cfilesDownloadArchiveUrl', $contentContainer->createUrl('/cfiles/zip/download-archive', ['fid' => '--folderId--']));
$this->registerJsVar('cfilesMoveUrl', $contentContainer->createUrl('/cfiles/move', ['init' => 1]));
?>
            ...
            <?php else: ?>
                ...
                <?php if ($this->context->canWrite() || !Setting::Get('disableZipSupport', 'cfiles')): ?>
                    <div class="col-sm-4 selectedOnly">
                        ...
                        $buttons = [];
                        if ($this->context->canWrite()):
                            $buttons[] = \humhub\widgets\AjaxButton::widget([
