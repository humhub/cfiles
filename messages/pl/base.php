...
return array (
  ...
  '<strong>Note:</strong> The replacement behaviour is currently not supported for zip imports.' => '<strong>Notatka:</strong> Zachowanie zastępcze jest aktualnie nie wspieranie dla impurtu zip.',
  ...
  'Replace existing files' => 'Zastąp istniejące pliki',
  'Root' => 'Root',
  ...
  'Upload behaviour for existing file names' => 'Zachowanie wgrywania wobec istniejących nazw plików',
  ...
  'Use of file indexes for already existing files' => 'Użycie indeksu plików dla już istniejących plików',
