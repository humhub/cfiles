...
return [
  ...
  'Could not import file with guid {guid}. File not found' => 'Nie udało się zaimportować pliku z guid {guid}. Nie odnaleziono pliku',
  ...
  'File (Module)' => 'Plik (moduł)',
  'File content ID' => 'ID zawartości pliku',
  ...
  'Folder content ID' => 'ID zawartości folderu',
