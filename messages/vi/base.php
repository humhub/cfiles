...
return array (
  ...
  '<strong>Note:</strong> The replacement behaviour is currently not supported for zip imports.' => '<strong>Ghi chú:</strong> Hành động thay thế hiện không được hỗ trợ bởi zip imports.',
  ...
  'Replace existing files' => 'Thay thế files đã tồn tại',
  'Root' => 'Thư mục gốc',
  ...
  'Updated' => 'Đã cập nhật',
  'Upload behaviour for existing file names' => 'Hành động upload cho tên tệp đã tồn tại',
  ...
  'Use of file indexes for already existing files' => 'Sử dụng chỉ mục tệp cho các file đã tồn tại',
