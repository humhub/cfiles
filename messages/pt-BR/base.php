...
return array (
  ...
  '<strong>Note:</strong> The replacement behaviour is currently not supported for zip imports.' => '<strong> Observação: </strong> o comportamento de substituição atualmente não é compatível com importações zip.',
